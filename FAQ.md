...
C+++ 的设计理念是保持与 ISO C++ 的完全兼容性。当不使用插件时，所有 C+++ 代码都是有效的 ISO C++ 代码。这意味着您可以逐步采用 C+++ 的特性，而不需要完全重写现有代码。

### 如何获取 C+++ 的最新版本？

C+++ 是 LLVM 项目的一部分，您可以通过克隆 LLVM/Clang 仓库并构建来获取最新版本：
...
C+++ 是 LLVM 项目的一部分，您可以按照 LLVM 项目的贡献指南来贡献代码：
...
您可以在 C+++项目的 issue 跟踪器中报告 C+++ 的 bug：

[https://github.com/TBNLZLDYD//cplusplusplus](https://github.com/llvm/llvm-project/issues)
